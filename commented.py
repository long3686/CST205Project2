#Course: CST 205 Fall 2016
#Title: FileGone
#Abstract: FileGone encrypts a specified file while sensing a user's presence via webcam and microphone.
#Authors: Jared Long, MooYoung Oh, Hugo Hernandez
#Date: 10-13-2016
